...
export default function GuidesPage() {
  ...
  return (
    <div style={{ maxWidth: 900, margin: '0 auto', padding: '60px 24px 80px' }}>
      ...
      <div style={{ marginBottom: 48 }}>
        <div style={{ display: 'inline-flex', alignItems: 'center', gap: 8, background: 'rgba(110,231,183,0.08)', border: '1px solid rgba(110,231,183,0.18)', borderRadius: 30, padding: '6px 16px', marginBottom: 20 }}>
          <span style={{ fontSize: 13 }}>📖</span>
          <span style={{ fontSize: 10, fontWeight: 700, letterSpacing: '0.15em', textTransform: 'uppercase', color: S.mint }}>Guides</span>
        </div>
        <h1 style={{ fontFamily: S.serif, fontSize: 'clamp(32px,5vw,44px)', fontWeight: 700, lineHeight: 1.1, letterSpacing: '-0.03em', color: S.cream, margin: '0 0 12px' }}>
          How to track <em style={{ color: S.mint }}>anything</em>
        </h1>
        <p style={{ fontSize: 16, lineHeight: 1.6, color: 'rgba(247,246,243,0.5)', fontWeight: 300, maxWidth: 500 }}>
          Step-by-step guides on using Steward to track campsites, restaurants, flights, tickets, and more.
        </p>
      </div>
