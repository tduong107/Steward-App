...
const NAV_LINKS = [
  { label: 'How We Compare', href: '/blog/comparisons' },
...
export default function BlogLayout({ children }: { children: React.ReactNode }) {
  return (
    ...
    >
      {/* ── Nav — matches landing page header ── */}
      <nav
        style={{
      ...
      >
        ...
        <Link href="/" style={{ display: 'flex', alignItems: 'center', gap: 10, textDecoration: 'none' }}>
          <svg width="30" height="30" viewBox="0 0 1024 1024" fill="none">
            ...
            <defs>
              <linearGradient id="bl1" x1="512" y1="0" x2="512" y2="1024"><stop offset="0%" stopColor="#243D30"/><stop offset="100%" stopColor="#0F2018"/></linearGradient>
              <linearGradient id="bl2" x1="512" y1="357" x2="512" y2="667"><stop offset="0%" stopColor="#FFFFFF"/><stop offset="50%" stopColor="#D1FAE5"/><stop offset="100%" stopColor="#6EE7B7"/></linearGradient>
              <radialGradient id="bl3" cx="30%" cy="30%" r="70%"><stop offset="0%" stopColor="#FFFFFF"/><stop offset="100%" stopColor="#6EE7B7"/></radialGradient>
            </defs>
          </svg>
        ...
        {/* Nav links — same style as landing page */}
